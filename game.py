...
GAMES = {
    ...
    'SpaceInvader':    [ "importlib.import_module('SpaceInvader').SpaceInvaderS", 
    ...
    'BreakoutSRA':   [ "importlib.import_module('BreakoutRA').BreakoutSRA", 
                     "game.fire_enabled = True" ],
    
      'SpaceInvaderSRA':   [ "importlib.import_module('SpaceInvaderRA').SpaceInvaderSRA", 
                     "game.fire_enabled = True" ],
